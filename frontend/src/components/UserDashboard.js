                ...
                {scanResult.success ? (
                  ...
                  <div>
                    <div className="flex items-center mb-2">
                      ...
                      <h3 className="text-lg font-semibold text-orange-800">Cooldown aktywny</h3>
                    </div>
                    <p className="text-orange-700">{scanResult.message}</p>
                    <p className="text-sm text-orange-600 mt-1">System zabezpiecza przed przypadkowym wielokrotnym skanowaniem.</p>
                  </div>
                ) : scanResult.isUnauthorized ? (
                  <div>
                    <div className="flex items-center mb-2">
